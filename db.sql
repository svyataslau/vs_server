...
CREATE TABLE user_challenge (
                            ...
                            default_promise_id INTEGER REFERENCES  promise(id) ON DELETE  CASCADE,
...
INSERT INTO user_challenge (user_id, promise_id, description, start_date, days_number) VALUES (1,3,'I want to learn java & spring', '2022-07-03', 30);
INSERT INTO user_challenge (user_id, promise_id, description, start_date, days_number) VALUES (2,4,'I have to lose 20 kg', '2022-06-03', 60);
INSERT INTO user_challenge (user_id, promise_id, description, start_date, days_number) VALUES (3,3,'I want to read a book about front-end 50 pages a day', '2022-07-22', 30);
INSERT INTO user_challenge (user_id, promise_id, description, start_date, days_number) VALUES (4,2,'learn how to swim', '2022-07-01', 20);
